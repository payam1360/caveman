...
document.addEventListener('DOMContentLoaded', () => {
  "use strict";
    ...
    resetStart(input, header, headerTxt, 'post');
    
    const moveright = document.querySelector('.form-go-right');
    moveRight(moveright, input, header, headerTxt, Questions, 'post');
    
    const moveleft = document.querySelector('.form-go-left');
    moveLeft(moveleft, input, header, headerTxt, Questions, 'post');
});
